...
function Results() {
  ...
  useEffect(() => {
    if (state?.result) {
      console.log("Places", state.result);
  ...
  if (!places.length) {
    return <div className=" font-livvic text-xl text-center mt-10">No places found or data missing.</div>;
  }

  const currentPlace = places[currentIndex];
  // split formatted into name + rest
  ...
  return (
    <div className="font-livvic flex flex-col items-center justify-center min-h-screen p-2 bg-gray-100">
      ...
      <section className="relative h-[750px] w-[356px] bg-cover bg-center rounded-2xl"
      ...
      >
        <div className="absolute inset-0">
          <AnimatePresence custom={direction} mode="wait">
            ...
            >
              <h1 className="text-white text-2xl font-semibold mt-10 mb-6">
                Well, You can Visit...
              </h1>

              <div className="relative text-white font-semibold flex flex-col">
                <h1 className="absolute text-[30px] p-0 top-0 left-0">
                  {name}
                </h1>
                <h2 className="absolute text-md mt-3 top-[70px]">
                  {rest}
                </h2>
              </div>
              ...
              <div className="relative text-center text-white font-semibold text-2xl">
                ...
                <button
                  ...
                  className="bg-orange-400 px-2 mt-2 py-1 rounded-xl"
                >
                  Click Here
                </button>
              </div>
              ...
              <div className="flex gap-4 justify-between">
                <button
                  ...
                  className={`text-xl font-semibold py-2 px-5 rounded-xl border ${
                    currentIndex === 0
                ...
                <button
                  ...
                  className={`text-xl font-semibold py-2 px-5 rounded-xl ${
